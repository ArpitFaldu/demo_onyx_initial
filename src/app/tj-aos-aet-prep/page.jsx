                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <h2 className="text-3xl font-bold mb-6 text-gray-800">
                            Proven{" "}
                            <span className="text-blue-800">Results</span>
                        </h2>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                className="bg-white rounded-xl p-6 shadow-lg border text-center hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2"
                            >
            ...
            <section className="py-16 bg-white">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <motion.div
                            {...fadeIn}
                            className="bg-blue-50 p-8 rounded-xl shadow-lg border hover:shadow-xl transition-all duration-300"
                        >
                            <div className="flex items-center gap-4 mb-6">
                                <div className="p-3 bg-blue-100 rounded-lg">
                                    <Image
                                        ...
                                        width={900}
                                        height={450}
                                        className="rounded transform transition-all duration-300 hover:scale-110 w-120 h-90"
                                    />
                                </div>
                            </div>
                        ...
                        <motion.div
                            {...fadeIn}
                            className="bg-yellow-50 p-8 rounded-xl shadow-lg border hover:shadow-xl transition-all duration-300"
                        >
                            <div className="flex items-center gap-4 mb-6">
                                <div className="p-3 bg-yellow-100 rounded-lg">
                                    <Image
            ...
            <section className="py-16 bg-gray-50">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <h2 className="text-3xl font-bold mb-6 text-gray-800">
                            Four Phases of{" "}
                            <span className="text-blue-800">Preparation</span>
                        </h2>
            ...
            <section className="py-16 bg-white">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <h2 className="text-3xl font-bold mb-6 text-gray-800">
                            Why Choose{" "}
                            <span className="text-blue-800">Our Program?</span>
                        </h2>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {[
                            ...
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                className="bg-gray-50 p-6 rounded-lg shadow-lg border hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2"
                            >

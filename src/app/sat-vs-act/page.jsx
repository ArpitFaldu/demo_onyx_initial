      ...
      <section className="relative pb-4 h-[400px] flex items-center justify-start overflow-hidden">
        ...
        <div className="relative z-10 w-full px-4 sm:px-6 md:px-8 lg:px-12 max-w-6xl mx-auto mt-22">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <span className="inline-block bg-yellow-500/20 text-yellow-400 border border-yellow-400/30 mb-4 font-semibold px-3 py-1 rounded-full text-sm">
              Choose Your Path
            </span>
            ...
            <div className="flex flex-row gap-3 sm:gap-4">
              <Link
                href="/sign-up"
                className="bg-yellow-500 hover:bg-yellow-600 text-black font-semibold px-6 sm:px-8 py-2 sm:py-3 w-auto transform transition-all duration-300 hover:scale-105 rounded-md inline-flex items-center justify-center"
              >
                GET STARTED
              </Link>
              <Link
                href="/contact-us"
                className="border-white text-white hover:bg-white hover:text-black px-6 sm:px-8 py-2 sm:py-3 w-auto transform transition-all duration-300 hover:scale-105 border rounded-md inline-flex items-center justify-center"
              >
                Contact Us
              </Link>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-8 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="bg-white p-1 rounded-xl border shadow-lg">
                <Image
                  src="/3.png"
              ...
              <table className="min-w-full border-collapse rounded-lg overflow-hidden shadow-lg">
                <thead>
                  <tr className="bg-[#0f3963]">
                    <th className="border border-gray-300 px-4 py-3 text-left text-white">Feature</th>
                    <th className="border border-gray-300 px-4 py-3 text-left text-white">Digital SAT</th>
                    <th className="border border-gray-300 px-4 py-3 text-left text-white">Digital ACT</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="bg-gray-50">
                    <td className="border border-gray-300 px-4 py-3 font-bold text-gray-800">Sections</td>
                    <td className="border border-gray-300 px-4 py-3 text-gray-700">Reading & Writing, Math</td>
                    <td className="border border-gray-300 px-4 py-3 text-gray-700">
                      English, Math, Reading, Optional Science
                    </td>
                  </tr>
                  <tr className="bg-white">
                    <td className="border border-gray-300 px-4 py-3 font-bold text-gray-800">Test Length</td>
                    <td className="border border-gray-300 px-4 py-3 text-gray-700">~2 hours 14 minutes</td>
                    <td className="border border-gray-300 px-4 py-3 text-gray-700">
                      ~2 hours 5 minutes (core sections)
                    </td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="border border-gray-300 px-4 py-3 font-bold text-gray-800">Science Section</td>
                    <td className="border border-gray-300 px-4 py-3 text-gray-700">Integrated into Reading/Math</td>
                    <td className="border border-gray-300 px-4 py-3 text-gray-700">
                      Separate Science section (now optional)
                    </td>
                  </tr>
                  <tr className="bg-white">
                    <td className="border border-gray-300 px-4 py-3 font-bold text-gray-800">Math Calculator</td>
                    <td className="border border-gray-300 px-4 py-3 text-gray-700">Built-in Desmos calculator</td>
                    <td className="border border-gray-300 px-4 py-3 text-gray-700">
                      Built-in calculator for Math section
                    </td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="border border-gray-300 px-4 py-3 font-bold text-gray-800">Scoring</td>
                    <td className="border border-gray-300 px-4 py-3 text-gray-700">400-1600</td>
                    <td className="border border-gray-300 px-4 py-3 text-gray-700">1-36 (composite score)</td>
                  </tr>
                  <tr className="bg-white">
                    <td className="border border-gray-300 px-4 py-3 font-bold text-gray-800">Timing Per Question</td>
                    <td className="border border-gray-300 px-4 py-3 text-gray-700">More time per question</td>
                    <td className="border border-gray-300 px-4 py-3 text-gray-700">Faster-paced</td>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <motion.div
              {...fadeIn}
              className="bg-white p-8 rounded-xl shadow-lg border relative overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2"
            >
              ...
              <div className="flex items-center gap-4 mb-6">
                <div className="p-3 bg-yellow-100 rounded-lg">
                  <Image 
                    ...
                    width={740} 
                    height={500} 
                    className="rounded m-3 hover:scale-110 w-100 h-100 object-cover"
                    />
                </div>
              </div>
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex items-start gap-3">
                  <div className="min-w-8 h-8 flex items-center justify-center bg-yellow-100 rounded-full mt-1">
            ...
            >
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex items-start gap-3">
                  <div className="min-w-8 h-8 flex items-center justify-center bg-blue-100 rounded-full mt-1">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
              className="bg-gray-50 p-8 rounded-xl shadow-lg border hover:shadow-xl transition-shadow duration-300"
            >
              <h3 className="text-2xl font-bold mb-6 text-blue-800">Why These Tests Matter</h3>

              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <div className="min-w-10 h-10 flex items-center justify-center bg-yellow-100 rounded-full mt-1">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/sign-up"
                className="bg-yellow-500 hover:bg-yellow-600 text-black font-semibold px-8 py-3 transform transition-all duration-300 hover:scale-105 rounded-lg inline-flex items-center justify-center"
              >
                Take a Practice Test
              </Link>
              <Link
                href="/contact-us"
                className="border-white text-white hover:bg-white hover:text-blue-900 px-8 py-3 transform transition-all duration-300 hover:scale-105 border-2 rounded-lg inline-flex items-center justify-center"
              >
